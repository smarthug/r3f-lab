        ...
        <Canvas shadows camera={{ position: [-50, -25, 150], fov: 15 }}>
            <Suspense fallback={null}>
                ...
                <Physics colliders={false}>
                    ...
                    <CollisionBox visible={false} position={[-0.46, -6.47243272649825, 2.27]} scale={[12.55, 2, 4.84]} />
                    <CollisionBox visible={false} position={[1.92, -16.14, 1.85]} rotation={[0, 0.82, 0]} scale={[12.55, 2, 7.78]} />
                    <CollisionBox visible={false} position={[-1.35, -26.46, -0.54]} rotation={[0, 0.67, 0]} scale={[12.55, 2, 9.11]} />
