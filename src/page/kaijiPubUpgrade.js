...
function ThreeHolePlate(props) {
    ...
    return (
        <RigidBody ref={ref} colliders="trimesh" type="kinematicPosition">
            ...
            <CollisionBox visible={true} position={[-0.46, -6.47243272649825 + 10, 2.27]} args={[12.55 / 2, 2 / 2, 4.84 / 2]} />
        </RigidBody>
    )
}
...
function FourHolePlate(props) {
    ...
    return (
        <RigidBody ref={ref} colliders="trimesh" type="kinematicPosition">
            ...
            <CollisionBox visible={true} position={[1.92, -16.14 + 10, 1.85]} rotation={[0, 0.82, 0]} args={[12.55 / 2, 2 / 2, 7.78 / 2]} />
        </RigidBody>
    )
}
...
function FiveHolePlate(props) {
    ...
    return (
        <RigidBody position={props.position} ref={ref} colliders="trimesh" type="kinematicPosition">
            ...
            <CollisionBox visible={true} position={[-1.35, -1.5, -0.54]} rotation={[0, 0.67, 0]} args={[12.55 / 2, 2 / 2, 9.11 / 2]} />
        </RigidBody>
    )
}
